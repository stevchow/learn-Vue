<template>
  <div id="app">
    <h1>Filter</h1>
    <p>{{ textHello1 | toLowerCase }}</p>
    <p>{{ textHello2 | toLowerCase | to-uppercase }}</p>
    <hr>
    <h2>Please considere to use computed properties instead of filter cause of performance and complexity issue</h2>
